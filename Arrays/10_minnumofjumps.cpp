...
int minJumps(int arr[], int n)
{
    ...
    // initialization of variable that stores all time the maximal reachable index in the array.
    int maxReach = arr[0];
...
int main()
{
    ...
    cout<<"Minimum number of jumps to reach the end of the array is "<< minJumps(arr, n);
    return 0;
}
